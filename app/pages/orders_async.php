...
?>
    ...
    <div class="container">
        <form action="orders_async.php">
            ...
            <div class="row mb-3">
                <div class="col-3">
                    <button type="button" class="btn btn-success btn-form-async" data-action="orders_async" data-target="main">
                        Guardar
                    </button>
                    <button type="button" class="btn btn-dark btn-load-async" data-action="orders.php" data-type="list-orders" data-target="main">
                        Cancelar
                    </button>
                </div>
            </div>
